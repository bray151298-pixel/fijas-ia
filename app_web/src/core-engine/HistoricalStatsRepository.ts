...
export class HistoricalStatsRepository {
  ...
  private leagueStats: Record<string, LeagueAverages> = {
    ...
    'Serie A': { league: 'Serie A', avgHomeGoals: 1.48, avgAwayGoals: 1.12, totalMatchesSampled: 380 },
    'Bundesliga': { league: 'Bundesliga', avgHomeGoals: 1.72, avgAwayGoals: 1.34, totalMatchesSampled: 306 },
    'UEFA Champions League': { league: 'UEFA Champions League', avgHomeGoals: 1.65, avgAwayGoals: 1.25, totalMatchesSampled: 125 },
