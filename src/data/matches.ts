...
export const INITIAL_TRACKED_PICKS: TrackedPick[] = [
  ...
  // Settled Historical Picks (Audit History)
  {
    id: 'tp-099',
    sport: 'football',
  ...
  },
  {
    ...
    telegramNotified: true,
    settlementNotes: 'Zverev metió 22 aces con 82% de primer saque. Diagnosticado en ciclo IA.',
    clvPercent: 2.0
  },
  {
    id: 'tp-095',
  ...
  },
  {
    ...
    telegramNotified: true,
    settlementNotes: 'Merab aplicó 6 derribos de control. Combate de 25 minutos completos.',
    clvPercent: 3.8
  }
];
